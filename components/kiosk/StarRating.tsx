...
export function StarRating({ value, onChange, questionId }: StarRatingProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2" role="radiogroup" aria-label="Rating">
        {[1, 2, 3, 4, 5].map((star) => {
          ...
          return (
            ...
            >
              <svg viewBox="0 0 24 24" fill="currentColor"
                className={cn(
                  "w-7 h-7 sm:w-8 sm:h-8 md:w-11 md:h-11 transition-all duration-100",
        ...
        {value !== null && (
          <span className="font-mono text-[11px] md:text-[14px] text-[#888] ml-1">
